...
def create_encoder(enc_type, output_stride=8, pretrained=True):
    ...
    elif enc_type.startswith('efficientnet'):
        return EfficientNet.encoder(enc_type, pretrained=pretrained)
        #return EfficientNet.from_pretrained(enc_type)
    ...
    #     return se_net(enc_type, pretrained)
        ...
        return MobileNetV2(pretrained=False)
    else:
